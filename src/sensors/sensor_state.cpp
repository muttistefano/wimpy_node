...
using robotis::wimpy::sensors::SensorState;
  ...
  std::shared_ptr<DynamixelSDKWrapper> & dxl_sdk_wrapper)
{
  ...
  msg->left_encoder = dxl_sdk_wrapper->get_data_from_device<int32_t>(
    extern_control_table.present_position_fleft.addr,
    extern_control_table.present_position_fleft.length);

  msg->right_encoder = dxl_sdk_wrapper->get_data_from_device<int32_t>(
    extern_control_table.present_position_fright.addr,
    extern_control_table.present_position_fright.length);
