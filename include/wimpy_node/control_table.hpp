...
#ifndef wimpy_node__CONTROL_TABLE_HPP_
#define wimpy_node__CONTROL_TABLE_HPP_
...
typedef struct
{
  ...
  ControlItem present_current_fleft = {120, RAM, 4, READ};
  ControlItem present_current_fright = {124, RAM, 4, READ};
  ControlItem present_current_rleft = {128, RAM, 4, READ};
  ControlItem present_current_rright = {132, RAM, 4, READ};
  ControlItem present_velocity_fleft = {136, RAM, 4, READ};
  ControlItem present_velocity_fright = {140, RAM, 4, READ};
  ControlItem present_velocity_rleft = {144, RAM, 4, READ};
  ControlItem present_velocity_rright = {148, RAM, 4, READ};
  ControlItem present_position_fleft = {152, RAM, 4, READ};
  ControlItem present_position_fright = {156, RAM, 4, READ};
  ControlItem present_position_rleft = {160, RAM, 4, READ};
  ControlItem present_position_rright = {164, RAM, 4, READ};
  ...
  ControlItem profile_acceleration_fleft = {194, RAM, 4, READ_WRITE};
  ControlItem profile_acceleration_fright = {198, RAM, 4, READ_WRITE};
  ControlItem profile_acceleration_rleft = {202, RAM, 4, READ_WRITE};
  ControlItem profile_acceleration_rright = {206, RAM, 4, READ_WRITE};
} ControlTable;
...
#endif  // wimpy_node__CONTROL_TABLE_HPP_
